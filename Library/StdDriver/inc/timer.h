 ...
 * $Revision: 8 $
 * $Date: 16/10/25 4:25p $
 * @brief    M071Q_M071V series Timer Controller(Timer) driver header file
 *
 * @note
...
#define TIMER_TRGSEL_TIMEOUT_EVENT              (0UL << TIMER_TRGCTL_TRGSSEL_Pos) /*!< Select internal trigger source from timer time-out event */
#define TIMER_TRGSEL_CAPTURE_EVENT              (1UL << TIMER_TRGCTL_TRGSSEL_Pos) /*!< Select internal trigger source from timer capture event */
