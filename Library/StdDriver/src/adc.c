 ...
 * $Revision: 6 $
 * $Date: 16/10/25 4:25p $
 * @brief    M071Q_M071V series ADC driver source file
 *
 * @note
...
/**
  ...
  * @return  None
  * @note M071Q_M071V series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
