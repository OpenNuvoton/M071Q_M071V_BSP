 ...
 * @brief    M071Q_M071V series USBD VCOM and Mass-storage sample file
 *
 * @note
...
//------------------------------------------------------------------
    if(u32IntSts & USBD_INTSTS_BUS)
    {
        ...
        {
            extern void FlashCacheFlush(void);
...
{
    /* Bulk OUT */
    if((g_u32OutToggle == (USBD->EPSTS & USBD_EPSTS_EPSTS6_Msk)) && !g_u32CbwStall)
    {
        g_u32OutSkip = 1;
