 ...
 * @return      None
 *
 * @details     The RTC_IRQHandler is default IRQ of RTC, declared in startup_NUC126.s.
 */
...
int main(void)
{
    ...
    printf("# Set RTC current date/time: 2016/05/15 23:59:50.\n");
    printf("# Set RTC alarm date/time:   2016/05/15 23:59:55.\n");
    ...
    printf("\n\n");
    printf("# Set next RTC alarm date/time: 2016/05/16 00:00:05.\n");
    printf("# Wait system waken-up by RTC alarm interrupt event.\n");
    RTC_SetAlarmDate(2016, 05, 16);
