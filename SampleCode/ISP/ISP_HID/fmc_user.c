/***************************************************************************//**
 * @file     fmc_user.c
 * @brief    M071Q_M071V series FMC driver source file
 * @version  2.0.0
 *
...
{
    // For M071Q_M071V series, CONIFG2 must be 0xFFFFFF5A (Don't modify this value. It should be 0xFFFFFF5A after reset.)
