...
int main(void)
{
    ...
    RTC->CAL     = 0x00160515;          /* Date: 2016/05/15 */
    RTC->TIME    = 0x00153030;          /* Time: 15:30:30 */

    /* Setting RTC alarm date/time and enable alarm interrupt */
    RTC->CALM  = 0x00160515;            /* Date: 2016/05/15 */
    RTC->TALM  = 0x00153035;            /* Time: 15:30:35 */
    RTC->INTEN = RTC_INTEN_ALMIEN_Msk;

    printf("# Set RTC current date/time: 2016/05/15 15:30:30.\n");
    printf("# Set RTC alarm date/time:   2016/05/15 15:30:35.\n");
