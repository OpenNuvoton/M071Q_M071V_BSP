...
void SYS_Init(void)
{
    ...
    SYS->GPC_MFPL &= ~(SYS_GPC_MFPL_PC6MFP_Msk | SYS_GPC_MFPH_PC11MFP_Msk);
    SYS->GPC_MFPL |= (SYS_GPC_MFPL_PC6MFP_PWM1_CH0 | SYS_GPC_MFPH_PC11MFP_PWM1_CH2);
}
...
int32_t main(void)
{
    ...
    while(1)
    {
        ...
        */
        ...
        PDMA->REQSEL0_3 = (PDMA->REQSEL0_3 & ~PDMA_REQSEL0_3_REQSRC0_Msk) | (PDMA_PWM1_P2_RX << PDMA_REQSEL0_3_REQSRC0_Pos);
