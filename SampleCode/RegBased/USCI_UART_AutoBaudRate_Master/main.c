...
void USCI_AutoBaudRate_TxTest(void)
{
    ...
    do
    {
        ...
        {
            case '1':
                UUART0->BRGEN = ((267 << UUART_BRGEN_CLKDIV_Pos) | (6 << UUART_BRGEN_DSCNT_Pos));
                break;

            case '2':
                UUART0->BRGEN = ((207 << UUART_BRGEN_CLKDIV_Pos) | (5 << UUART_BRGEN_DSCNT_Pos));
                break;

            default:
                UUART0->BRGEN = ((103 << UUART_BRGEN_CLKDIV_Pos) | (5 << UUART_BRGEN_DSCNT_Pos));
                break;
        }
